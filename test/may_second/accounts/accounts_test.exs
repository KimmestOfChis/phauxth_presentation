defmodule MaySecond.AccountsTest do
  use MaySecond.DataCase

  alias MaySecond.Accounts
  alias MaySecond.Accounts.User

  @create_attrs %{first_name: "User", last_name: "McUserson", secret: "I'm actually Canadian", role: "Buyer", email: "fred@example.com", password: "reallyHard2gue$$"}
